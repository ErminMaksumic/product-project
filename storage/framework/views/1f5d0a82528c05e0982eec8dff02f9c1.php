					...
					<?php if($showTotalColumns != [] && $ctr > 1): ?>
						<tr class="bg-black f-white">
                            <?php if($showNumColumn || $grandTotalSkip > 1): ?>
                                <td colspan="<?php echo e($grandTotalSkip); ?>"><b><?php echo e(__('laravel-report-generator::messages.grand_total')); ?></b></td> 
                            <?php endif; ?>
							<?php $dataFound = false; ?>
							<?php $__currentLoopData = $columns; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $colName => $colData): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
...
<?php /**PATH C:\Users\User\OneDrive\Desktop\Project\PHP-project\product-project\resources\views/vendor/laravel-report-generator/general-pdf-template.blade.php ENDPATH**/ ?>